export default class SplashScreen extends Phaser.Scene {
   ...
   */
  showCover() {
    this.add.image(this.cameras.main.centerX, this.cameras.main.centerY, 'splash-screen').setOrigin(0.5);
  }
  ...
  showProgressBar() {
    ...
    const img = this.add.sprite(this.cameras.main.centerX, this.cameras.main.centerY+58, 'progress-bar').setOrigin(0.5);
